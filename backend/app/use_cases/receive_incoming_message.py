...
class ReceiveIncomingMessageUseCase:
    ...
    async def execute(self, input: IncomingMessageInput) -> Opportunity:  # noqa: A002
        async with SQLAlchemyUnitOfWork(self._session_factory) as uow:
            ...
            # Se incrementa sin importar el attention_mode -- indica actividad nueva sin revisar,
            # no "necesita intervención humana" (eso ya lo indica attention_mode por su cuenta).
            opportunity.increment_unread()
